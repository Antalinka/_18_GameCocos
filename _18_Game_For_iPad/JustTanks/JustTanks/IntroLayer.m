...
//  Copyright Evgenia 2014. All rights reserved.
//
...
-(void) onEnter
{
    ...
    [[SimpleAudioEngine sharedEngine] preloadEffect:@"regular.wav"];

	[[CCDirector sharedDirector] replaceScene:[CCTransitionFade transitionWithDuration:1.0 scene:[JTMainMenuScene scene] ]];
}
@end
