...
-(void) createSmoke{
    if (self.scene.isMovingForward ||self.scene.isMovingBack || self.scene.isRotatingLeft ||  self.scene.isRotatingRight) {
...
-(void) shoot{
    ...
    if (![self.scene getChildByTag:bullet_tag] && _bullets > 0) {
        ...
        NSDictionary* dict = [NSDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithFloat:450],key_shot_distance,
